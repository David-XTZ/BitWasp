            ...
            <div class="col-md-9">
                <h2>{lang('login')}</h2>
                {assign var="defaultMessage" value=lang("enter_your_details_to_continue")}
                ...
                {form method="open" action="login" attr=['class'=>'form-horizontal', 'name' => 'loginForm']}
                    ...
                    <fieldset>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <label class="control-label col-md-2" for="user_name">{lang('username')}</label>
                                <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <label class="control-label col-md-2" for="password">{lang('password')}</label>
                                <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-lg-5 col-md-5">
                                <p align="center">
                                    ...
                                    {url type="anchor" url="register" text=lang("register") attr='title="Register" class="btn btn-default"'}
                                </p>
                            </div>
                        </div>
